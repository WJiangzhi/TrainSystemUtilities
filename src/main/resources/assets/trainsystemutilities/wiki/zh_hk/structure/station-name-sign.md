...
A 月台 車站 name 板, 4 方塊 wide 和 1 方塊 t全部. Place it **inside a 車站 group range** 和 it au以matic全部y 顯示  車站 name, 線路 col或 和 neighb或ing 車站, on both faces. re is no UI — everything shown is derived from  車站 group 和  分配 線路 編號.
...
- Neighb或s are resolved **from  軌道 網絡**: starting at this 車站,  first different 車站 group found in each directi在…上long  軌道 is shown. Left/right 分配ment follows  sign's facing au以matic全部y.
...
- [自動售票機](ticket-vending-machine.md) / [站台圍欄](platform-fence.md)
