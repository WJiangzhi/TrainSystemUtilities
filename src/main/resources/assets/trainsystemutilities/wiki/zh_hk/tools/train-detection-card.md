...
> Those are adjusted on  [SAS 廣播設置](../railway-management/announcement.md) GUI after you insert  rec或ded 卡 in以  railway management 方塊.
...
2. Right-click 以 open  [鐵路管理方塊](../railway-management.md), n open  [SAS 廣播設置](../railway-management/announcement.md).
