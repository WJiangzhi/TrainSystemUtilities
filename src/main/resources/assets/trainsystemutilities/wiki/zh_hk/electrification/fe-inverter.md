...
5.  inverter outputs FE 以 adjacent 方塊 通過  IEnergyS以rage capability.
...
|---|---|
| **Mekanism** | Adjacent connection 通過 Universal Cable / Ultimate Energy Cube, 等 |
| **Applied Energistics 2** | Connect 通過 Energy Cell / Energy Accep以r |
| **Industrial F或egoing** | Connect 通過 Power Conduit |
| **Create** (通過 Electric Engine) | Adjacent 用於 FE → Rotational F或ce conversion |
| 其他 FE-compatible mods | All connectable 通過 IEnergyS以rage |
