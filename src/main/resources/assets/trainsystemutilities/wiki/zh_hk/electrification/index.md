...
> [!TIP]
> 圖標 帶有 **藍色標記** in  右下角 can be clicked 以 open ir 詳情 頁面.

 Train系統 Utilities electrification system supplies external FE power 以 Create 列車 通過 **overhead wire + pan以graph + sub車站**.
...
4. Hold  [連接工具 Tool](wire-connector.md) 和 right-click **insula以r → insula以r** in 或der 以 string [Wire](wire-connector.md) over  軌道 (power flows from  insula以r adjacent 以  sub車站).
...
| Item | 作用 | 詳情 |
|---|---|---|
| [連接工具 Tool](wire-connector.md) | Strings wire between two insula以rs | Hold 和 right-click insula以rs. 5 designs + [自定義](custom-wire.md) |
...
- [Wire / 連接工具 Tool](wire-connector.md)
